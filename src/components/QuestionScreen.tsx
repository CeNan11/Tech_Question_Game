...
const QuestionScreen: React.FC<Props> = ({ question, currentIndex, total, onNext }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-white font-shareTech bg-white/20 h-[400px] w-[700px] rounded-lg py-4 px-5 flex flex-col">
            ...
            {hasAnswered ? (
              <>
                <p className="text-lg font-bold">
                  {isCorrect ? "" : `❌ Wrong! The correct answer is: ${question.answer}`}
                </p>
                <button
                  type="button"
                  onClick={onNext}
